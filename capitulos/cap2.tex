...
\begin{exemplo}[Variância de Árvores de Decisão]
Voltando ao exemplo da árvore de regressão para preços de casas. Vamos agora selecionar aleatoriamente várias amostras de apartamentos e treinar uma árvore e um modelo linear (estimado por OLS) em cada. O que acontece com o aluguel presumido para apartamentos iguais?
...
Agregando as previsões, as diferenças diminuem consideravelmente:
