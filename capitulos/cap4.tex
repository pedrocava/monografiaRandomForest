...
\begin{figure}[H]
    ...
    \captionbox{Comportamento dos efeitos marginais, que lembra um ruído branco, e a curva de predições. Elaboração própria.}{\includegraphics[scale = .45]{imagens/exemplo_freddy_efeitos marginais.png}}
\end{figure}
