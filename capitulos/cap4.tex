...
\begin{figure}[H]
    ...
    \captionbox{Dados simulados. Elaboração própria.}{\includegraphics[scale = .75]{imagens/exemplo_freddy_fake_data.png}}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionbox{Comportamento dos efeitos marginais, que lembra um ruído branco, e a curva de predições. Elaboração própria.}{\includegraphics[scale = .50]{imagens/exemplo_freddy_efeitos_marginais.png}}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionbox{Comparação das predições com os valores verdadeiros. Elaboração própria.}{\includegraphics[scale = .55]{imagens/exemplo_freddy_predito_vs_verdade.png}}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionbox{Duas buscas de 100 modelos cada. Elaboração própria.}{\includegraphics[scale = .75]{imagens/random_grid.png}}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionbox{Resumo de métricas de performance variando quantas variáveis alimentar para cada árvore. Elaboração própria.}{\includegraphics[scale = .72]{imagens/cross_v_mtry.png}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \captionbox{Resumo de métricas de performance variando a amostra mínima para criar uma folha. Elaboração própria.}{\includegraphics[scale = .70]{imagens/crossv_min.png}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \captionbox{Cada curva contém a previsão de uma floresta aleatória distinta. Elaboração própria.}{\includegraphics[scale = .60]{imagens/curvas_previsoes_rf.png}}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionbox{Em florestas aleatórias a heterogeneidade dos efeitos de tratamento fica evidente. Elaboração própria.}{\includegraphics[scale = .60]{imagens/efeitos_marginais_RF.png}}
\end{figure}
