...
As tabelas \ref{tab:tabela1_exemplo4} e \ref{tab:tabela2_exemplo4} mostram as estimativas de dois modelos, um com $x$ e uma constante, outro com $x$, a constante e $x^2$. O segundo modelo recupera os parâmetros com erros da ordem de $1\%$. 

\input{tabelas/tabela1_exemplo4}
\input{tabelas/tabela2_exemplo4}
