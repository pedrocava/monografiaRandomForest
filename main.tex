...
\captionsetup{format=hang, justification=raggedright, singlelinecheck=false, figureposition=top}
...
\titulo{Computação de Efeitos Marginais em Modelos Classificados e Aplicações em Modelagem Econométrica}
